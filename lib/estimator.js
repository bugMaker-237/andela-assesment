...
const getDayFactor = (periodType, timeToElapse) => Math.trunc(getDays(periodType, timeToElapse) / 3);
/**
...
function setSevereCasesByRequestedTime(data) {
  ...
  impact.severeCasesByRequestedTime = Math.trunc(impact.infectionsByRequestedTime * Rates.infectionsByRequestedTime);
  severeImpact.severeCasesByRequestedTime = Math.trunc(severeImpact.infectionsByRequestedTime * Rates.infectionsByRequestedTime);
  return buildOutput(input, impact, severeImpact);
}
/**
...
function setHospitalBedsByRequestedTime(data) {
  ...
  impact.hospitalBedsByRequestedTime = Math.trunc(bedAvailaibility - impact.severeCasesByRequestedTime);
  severeImpact.hospitalBedsByRequestedTime = Math.trunc(bedAvailaibility - severeImpact.severeCasesByRequestedTime);
  return buildOutput(input, impact, severeImpact);
}
/**
...
function setCasesForICUByRequestedTime(data) {
  ...
  impact.casesForICUByRequestedTime = Math.trunc(impact.infectionsByRequestedTime * Rates.casesForICUByRequestedTime);
  severeImpact.casesForICUByRequestedTime = Math.trunc(severeImpact.infectionsByRequestedTime * Rates.casesForICUByRequestedTime);
  return buildOutput(input, impact, severeImpact);
}
/**
...
function setCasesForVentilatorsByRequestedTime(data) {
  ...
  impact.casesForVentilatorsByRequestedTime = Math.trunc(impact.infectionsByRequestedTime * Rates.casesForVentilatorsByRequestedTime);
  severeImpact.casesForVentilatorsByRequestedTime = Math.trunc(severeImpact.infectionsByRequestedTime * Rates.casesForVentilatorsByRequestedTime);
  return buildOutput(input, impact, severeImpact);
}
/**
 * Sets casesForVentilatorsByRequestedTime
...
function setDollarsInFlight(data) {
  ...
  impact.dollarsInFlight = Math.trunc(impact.infectionsByRequestedTime * input.region.avgDailyIncomePopulation * input.region.avgDailyIncomeInUSD / getDays(input.periodType, input.timeToElapse));
  severeImpact.dollarsInFlight = Math.trunc(severeImpact.infectionsByRequestedTime * input.region.avgDailyIncomePopulation * input.region.avgDailyIncomeInUSD / getDays(input.periodType, input.timeToElapse));
  return buildOutput(input, impact, severeImpact);
}
/**
...
const covid19ImpactEstimator = data => setDollarsInFlight(setCasesForVentilatorsByRequestedTime(setCasesForICUByRequestedTime(setHospitalBedsByRequestedTime(setSevereCasesByRequestedTime(setInfectionsByRequestedTime(setCurrentlyInfected( // @ts-ignore
buildOutput(data, {}, {}))))))));
